...
import { PostsUserSearch } from "src/sections/post-user/posts-user-search";
import { PostsUserTable } from "src/sections/post-user/posts-user-table";
const now = new Date();
        ...
        <Container maxWidth="xl">
          <Stack spacing={3}>
            <Stack direction="row" justifyContent="space-between" spacing={4}>
              <Stack spacing={1}>
                <Typography variant="h4">Post User</Typography>
